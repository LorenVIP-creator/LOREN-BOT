...
Ikuti instruksi dari file/prompt yang user kirim. Ingat semua konteks percakapan sebelumnya."""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Halo bos! Gue AI nya LOREN MOD VIP 🇮🇩. Kirim teks, PDF, atau foto, gue paham kok 😎")
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if file_name.endswith(".txt"):
        ...
        try:
            ...
            for page in reader.pages[:10]: # max 10 halaman biar gak berat
    ...
    # Potong biar gak kena limit
    if len(text) > MAX_FILE_CHARS:
        text = text[:MAX_FILE_CHARS] + "\n\n[File kepotong karena kepanjangan]"

    msg = f"Baca dan ikuti instruksi dari file ini:\n{text}"
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    messages = [
        {"type": "text", "text": "Lihat gambar ini, pahami, dan ingat konteksnya"},
